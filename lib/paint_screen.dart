...
import 'package:scribble_app/final_leaderboard.dart';
import 'package:scribble_app/home_screen.dart';
import 'package:scribble_app/models/my_custom_painter.dart';
import 'package:scribble_app/models/touch_points.dart';
import 'package:scribble_app/sidebar/player_scoreboard_drawer.dart';
import 'package:scribble_app/waiting_lobby_screen.dart';
...
class _PaintScreenState extends State<PaintScreen> {
  ...
  void connect() {
    _socket = IO.io('https://skribbl-backend.onrender.com/', <String, dynamic>{
    ...
    _socket.on("notCorrectGame", (data)=> Navigator.of(context).pushAndRemoveUntil(MaterialPageRoute(builder: (context)=>HomeScreen()), (route) => false));
